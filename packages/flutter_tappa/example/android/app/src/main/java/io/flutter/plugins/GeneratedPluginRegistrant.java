...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    try {
      flutterEngine.getPlugins().add(new com.mba.flutter_tappa.FlutterTappaPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin flutter_tappa, com.mba.flutter_tappa.FlutterTappaPlugin", e);
    }
    try {
