...
class PermissionExplanationSheet extends StatelessWidget {
  ...
  String get _description {
    switch (type) {
      ...
      case PermissionType.camera:
        return 'We need camera access to let you take photos for document verification or profile updates. Photos are only used for the purpose you initiate and are not shared without your consent.';
      case PermissionType.gallery:
        return 'We need access to your photo library so you can upload images for document verification or profile photos. Images are only used for the purpose you initiate and are not shared without your consent.';
    }
  }
