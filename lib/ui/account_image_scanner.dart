...
/// then sends the image to Gemini to extract account number and bank name.
...
Future<AccountScanResult?> scanAccountFromImage(BuildContext context) async {
  // Privacy consent gate — camera and gallery
...
''';
    ...
    final Map<String, dynamic> jsonResult = jsonDecode(cleaned);
    return AccountScanResult(
      accountNumber: jsonResult['accountNumber']?.toString(),
      bankName: jsonResult['bankName']?.toString(),
    );
  } catch (e) {
