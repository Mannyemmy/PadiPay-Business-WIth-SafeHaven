...
import 'package:padi_pay_business/profile/upgrade_tier.dart';
import 'package:padi_pay_business/utils.dart';

class UserUpgradeManager extends StatefulWidget {
  final String tier;
  const UserUpgradeManager({super.key, required this.tier});

  @override
  State<UserUpgradeManager> createState() => _UserUpgradeManagerState();
}

class _UserUpgradeManagerState extends State<UserUpgradeManager> {
      ...
      if (response.statusCode == 200) {
        ...
        if (data['error'] == false) {
          ...
          if (countryData != null && countryData['states'] != null) {
            ...
            showToast('No states found for $country', Colors.red);
          }
        } else {
          setState(() => isLoadingStates = false);
          showToast('API returned an error', Colors.red);
        }
      }
    } catch (e) {
      setState(() => isLoadingStates = false);
      showToast('Failed to load states: $e', Colors.red);
    }
  }
                      ...
                      child: Row(
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              Text(
                                "Current Tier: ${int.parse(widget.tier)}",
                                style: TextStyle(
                        ...
                        children: [
                          ...
                          InkWell(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                color: widget.tier == "0" ? primaryColor : Colors.grey,
                                borderRadius: BorderRadius.circular(10),
                              ),
                              child: Text(
                                widget.tier == "0" ? "Upgrade To Tier 2" : "Upgraded",
                                style: GoogleFonts.inter(
                                  fontWeight: FontWeight.bold,
                                  fontSize: 13,
                                  color: Colors.white,
                        ...
                        children: [
                          ...
                          InkWell(
                            onTap: () {
                               ...
                               if (widget.tier == "0" || widget.tier == "2"||widget.tier=="3") {
                                return;
                              }
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                color: widget.tier == "3" ? Colors.grey : Color(0xFF9810FA),
                                borderRadius: BorderRadius.circular(10),
                              ),
                              child: Text(
                                widget.tier == "2"||widget.tier == "3" ? "Upgraded" : "Upgrade To Tier 3",
                                style: GoogleFonts.inter(
                                  fontSize: 13,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white,
