...
import 'package:padi_pay_business/kyb/identity_verification_constants.dart';
...
class _IdentityVerificationStep1PageState
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'We need access to your camera to capture your photo during the identity verification process. Your image will only be used for verification purposes.',
  ...
  Future<void> _onSubmit() async {
    ...
    debugPrint('QoreID applicantData: $applicantData');
  ...
  Future<void> _handleResult(Map<dynamic, dynamic>? result) async {
    ...
    if (isAlreadyInitiated || isSuccess) {
      ...
      navigateTo(context, const HomePage(), type: NavigationType.clearStack);
      return;
    }
    ...
    if (isInProgress) {
      ...
      //showSnackBar(context, 'Verification in progress', Colors.orange);
      navigateTo(context, const HomePage(), type: NavigationType.clearStack);
      return;
    }
            ...
            : SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 12),
                    Text(
                      'Provide your correct legal details to start verification. ',
                    ),
